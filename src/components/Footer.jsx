...
export default function Footer() {
  ...
  return (
    <div className='w-full  h-screen bg-[#f1f1f1] text-zinc-900 font-["Founders_Grotesk_X-Condensed"] flex gap-5 '>
        <div className='w-1/2 mt-10 px-5 h-full flex flex-col justify-between'>
            <div className="heading uppercase">
            <h1 className='text-[8vw] font-bold leading-none '>Eye-</h1>
            <h1 className='text-[8vw] font-bold leading-none '>Opening</h1>
            </div>
           
        </div>
        <div className='w-1/2'>
        <h1 className='text-[5vw] font-black mt-10  uppercase leading-none'>
            presentations
            </h1>
            <div className='links  mt-20 font--["Neue_Montreal"] relative flex gap-10 flex-col'>
            <div className='dets'>
                <h1 className=''>S:-</h1> 
                <a href="#">Google</a> <br />
            ...
            <div className='dets'>
                ...
                <a href="#">Lviv, Ukraine</a><br />
                <a href="#">30 Chukaria St</a><br />
            </div>  
            <div className='dets  relative'>
                <h1 className=''>E:-</h1> 
                <a href="#">engi.rajkumarmist@gmail.com</a> <br />
                <a href="#">9179641090</a>
                <svg className='absolute left-[80%] bottom-[10px]' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='dets absolute left-[50%]'>
                <h1 className='mt-20'>M:-</h1> 
                <a href="#">Home</a> <br />
                <a href="#">About</a><br />
